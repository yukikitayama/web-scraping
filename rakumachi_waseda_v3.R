...
# url <- "https://www.rakumachi.jp/syuuekibukken/area/prefecture/dimAll/?page=1&realtor_id=&area=&line=&st[]=2345040&limit=20&keyword=&newly=&price_from=&price_to=&gross_from=&gross_to=&dim[]=2001&year=&b_area_from=&b_area_to=&houses_ge=&houses_le=&min=&l_area_from=&l_area_to=&ex_real_search=&sort=property_created_at&sort_type=desc"

# Make list of url of individual page -------------------------------------

front <- "https://www.rakumachi.jp/syuuekibukken/area/prefecture/dimAll/?page="
back <- "&realtor_id=&area=&line=&st[]=2345040&limit=20&keyword=&newly=&price_from=&price_to=&gross_from=&gross_to=&dim[]=2001&year=&b_area_from=&b_area_to=&houses_ge=&houses_le=&min=&l_area_from=&l_area_to=&ex_real_search=&sort=property_created_at&sort_type=desc"
...
df$area <- ifelse(regexpr("文京区", df$address) > 0, "Bunkyo",
                  ifelse(regexpr("豊島区", df$address) > 0, "Toshima",
                                "Shinjuku"))
table(df$area)
df$prefecture <- "Tokyo"
...
saveRDS(df, "rakumachi_waseda_20181230.rds")
